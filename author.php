      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                ?>
                  <h2 class="page-heading"><?=$row['first_name']." ".$row['last_name']?></h2>
                    ...
                    <?php 
                        ...
                        // Show pagination
                        $sql1 = $sql1 = "SELECT * FROM post WHERE author={$authId}";
                        ...
                        if(mysqli_num_rows($result1) > 0) {
                            ...
                            if($page > 1) {
                                echo "<li><a href='author.php?id=".$authId."&page=".($page-1)."'>Prev</a></li>";
                            }
                            for($i=1; $i<=$total_pages; $i++) {
                                ...
                                echo "<li class='{$active}'><a href='author.php?id=".$authId."&page={$i}'>{$i}</a></li>";
                            }
                            if($total_pages > $page) {
                                echo "<li><a href=author.php?id=".$authId."&page=".($page+1).">Next</a></li>";
                            }
                            echo "</ul>";
                        }
                    ?>
